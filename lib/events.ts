...
Come dressed in traditional attire and be part of this vibrant celebration of Tamil culture!`,
    ...
    sponsors: [
      ...
      { name: "Dublux Properties", tier: "gold" },
      { name: "Murugan Foods Brisbane", tier: "silver" },
      { name: "Allionecart Indian Grocery", tier: "silver" },
    ],
    stalls: [
      { name: "Kothu", items: "Kottu paratta, Paruppu vada, Ulunthu vada, Dum briyani, Dosa, Idly", type: "Food" },
      { name: "Samy Store", items: "Idiyappam with Goat leg paya / Veg korma, Idly with kudal kari or sambar & chutney, Kal dosai (few varieties) with sambar & chutney or chicken gravy, Parotta with salna, Egg omelette / kalaki, Chicken & mutton chukka, May be mutton biriyani for taste only", type: "Food" },
      { name: "All in One Grocery and Murugan Foods", items: "Briyani, Samosa", type: "Food" },
      { name: "Pretty Yum Treats", items: "Real fruit ice cream, Yoghurt granola bowl, Natural fruit juice slushee, Choc choc dipped frozen treats", type: "Food" },
      ...
      { name: "Filter Coffee Shop", items: "Authentic filter coffee", type: "Food" },
      { name: "Potata Spiral", items: "Potato twirls", type: "Food" },
      { name: "Amazinggiftsforkidz", items: "Kids gifts like remote cars, LED based toys, Full list is emailed", type: "Kids" },
      { name: "Indi pride Jewellery shop", items: "Jewels and accessories", type: "Other" },
    ],
